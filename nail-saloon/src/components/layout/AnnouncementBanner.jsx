...
const AnnouncementBanner = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-[#2B1E16] via-[#4A3B32] to-[#2B1E16] text-[#FAF8F5] px-4 py-2 text-center text-xs font-medium relative z-50 transition-all border-b border-white/10 shadow-xs">
