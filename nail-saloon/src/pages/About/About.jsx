  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 animate-fade-in text-[#2B1E16]">
      ...
      <div className="text-center mb-14">
        <span className="text-xs uppercase tracking-widest bg-[#F5EFE6] px-3.5 py-1.5 rounded-full font-bold mb-3 inline-block text-[#8B5E3C]">
          Our Story
        </span>
        <h1 className="text-4xl md:text-5xl font-serif mb-4 leading-tight">Welcome to NailMuse Studio</h1>
        <p className="text-[#4A3B32] text-lg max-w-2xl mx-auto leading-relaxed">
      ...
      <div className="bg-white border border-[#F0EBE1] rounded-3xl p-8 md:p-12 shadow-sm mb-12 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="p-5 bg-[#FAF8F5] rounded-2xl border border-[#F0EBE1]">
            ...
            <h4 className="font-semibold mb-1 text-base">Expert Artists</h4>
            <p className="text-sm text-[#4A3B32] leading-relaxed">Certified professionals specialized in 3D art, Gel-X, and precision care.</p>
          </div>
          <div className="p-5 bg-[#FAF8F5] rounded-2xl border border-[#F0EBE1]">
            <span className="text-2xl mb-2 block">🌿</span>
            <h4 className="font-semibold mb-1 text-base">Clean & Safe</h4>
            <p className="text-sm text-[#4A3B32] leading-relaxed">Hospital-grade sterilization and premium eco-friendly products.</p>
          </div>
          <div className="p-5 bg-[#FAF8F5] rounded-2xl border border-[#F0EBE1]">
            <span className="text-2xl mb-2 block">🕒</span>
            <h4 className="font-semibold mb-1 text-base">Real-Time Queue</h4>
            <p className="text-sm text-[#4A3B32] leading-relaxed">Track your appointment wait times live without sitting idle in the salon.</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center">
        <button 
          ...
          className="bg-[#2B1E16] text-[#FAF8F5] px-8 py-3.5 rounded-xl text-base font-semibold hover:bg-[#4A3B32] transition-all shadow-md"
        >
